...
module Inferno
  module Sequence
    class DemoCancerrelatedradiationprocedureSequence < SequenceBase
      include Inferno::SequenceUtilities

      title 'Cancer-Related Radiation Procedure Tests'
      description 'Verify support for the server capabilities required by the Cancer-Related Radiation Procedure profile.'
      details %(
      )
      test_id_prefix 'CRRP'
      ...
      test :resource_read do
        metadata do
          ...
          link 'http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-cancer-related-radiation-procedure'
          description %(
        ...
        save_resource_references(versioned_resource_class('Procedure'), [@resource_found], 'http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-cancer-related-radiation-procedure')
      end
      ...
      test :resource_validate_profile do
        metadata do
          id '03'
          name 'Server returns Procedure resource that matches the Cancer-Related Radiation Procedure profile'
          link 'http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-cancer-related-radiation-procedure'
          description %(
            This test will validate that the Procedure resource returned from the server matches the Cancer-Related Radiation Procedure profile.
          )
          versions :r4
        end

        skip 'No resource found from Read test' unless @resource_found.present?
        test_resources_against_profile('Procedure', 'http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-cancer-related-radiation-procedure')
      end
    end
  end
end
